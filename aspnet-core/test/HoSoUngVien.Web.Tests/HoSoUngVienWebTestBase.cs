...
{
    public abstract class HoSoUngVienWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HoSoUngVienWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HoSoUngVienWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HoSoUngVienDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HoSoUngVienDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HoSoUngVienDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HoSoUngVienDbContext, Task<T>> func)
        {
            T result;
